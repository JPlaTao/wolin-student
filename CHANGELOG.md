...
### P3 — 通用 RAG 核心模块
- [x] 向量库抽象层 (VectorStore ABC + ChromaStore) — 2026-05-09
- [x] BM25 词项检索 + DashScope gte-rerank 重排序 — 2026-05-09
- [x] 混合检索管线：BM25∪Vector→去重→Rerank→TopK — 2026-05-09
- [x] 文档上传/切片预览/确认入库 API（POST /rag/upload, /rag/confirm）— 2026-05-09
- [x] 混合检索 API（POST /rag/search）— 2026-05-09
- [x] 全链路冒烟测试通过（上传→入库→检索→验证字段完整性）— 2026-05-09
- [x] Bug 修复：BM25 负分过滤、Chroma 维度不匹配、Chunk ID 丢失 — 2026-05-09

### P4 — RAG 知识库前端界面
- [x] 前端 Spec（需求规格）— 2026-05-09
- [x] 前端 Plan（技术架构方案）— 2026-05-09
